...
function renderPeople(people) {
    people.forEach(async (person) => {
      ...
      overlay.innerHTML = `
        <div class="card-details">
          ...
          <div class="more-info hidden">
              <p><strong>Height: </strong>${p.height !== "unknown" ? p.height + " cm" : p.height}</p>
              <p><strong>Mass: </strong>${p.mass !== "unknown" ? p.mass + " kg" : p.mass}</p>
              <p><strong>Hair: </strong>${p.hair_color}</p>
              <p><strong>Eyes: ${p.eye_color} </strong></p>
          </div>
          <div class="btn_style">
      ...
      const seeMoreBtn = overlay.querySelector(".see-more");
      const moreInfo = overlay.querySelector(".more-info");
      seeMoreBtn.addEventListener("click", () => {
        moreInfo.classList.toggle("hidden");
        overlay.classList.toggle("active");
        seeMoreBtn.textContent = moreInfo.classList.contains("hidden") 
          ? "See More" 
          : "See Less";
      });
    });
    ...
    overlay.innerHTML = `
      <div class="card-details">
        ...
        <div class="more-info hidden">
          ...
          <p><strong>Orbital Period: </strong>${p.orbital_period}</p>
        </div>
        <div class="btn_style">
            <button class="see-more">See More</button>
        </div>
...
peopleBtn.addEventListener("click", () => {
  ...
  peopleBtn.style.backgroundColor = "rgba(214, 32, 32, 0.55)";
  planetBtn.style.backgroundColor = "rgba(121, 109, 109, 0.35)";
...
planetBtn.addEventListener("click", () => {
  ...
  planetBtn.style.backgroundColor = "rgba(214, 32, 32, 0.55)";
  peopleBtn.style.backgroundColor = "rgba(121, 109, 109, 0.35)";
